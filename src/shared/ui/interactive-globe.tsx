...
// T006: interfaces and math helpers
...
// T008–T012: InteractiveGlobe component
...
export function InteractiveGlobe({
  ...
  // T008: Fibonacci sphere dot generation
  useEffect(() => {
  ...
  const draw = useCallback(() => {
    ...
    // T009: Canvas DPR setup + clear + glow + outline + dots
    ...
    // T010: arc connections + traveling dot
    ...
    // T011: city markers with pulse + label + rAF loop
